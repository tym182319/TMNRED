...
% EEG = pop_importNeuracle({'data.bdf','data.1.bdf','data.2.bdf','evt.bdf'}, filepath);
...
EEG = pop_icflag(EEG, [NaN NaN;0.8 1;0.6 1;NaN NaN;NaN NaN;0.6 1;0.7 1]); % brain muscle eye heart linenoise channelnoise other 
